...
const updateUserProfileHandler = (path, method, updateUserProfileUsecase, router) => __awaiter(void 0, void 0, void 0, function* () {
    (0, get_router_method_1.default)(router, method)(path, (0, validate_and_transform_schema_1.default)(schema_1.default), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const { id } = req.params;
            const users = yield updateUserProfileUsecase.execute(id, req.body);
            res.send(users);
        }
        catch (err) {
...
exports.default = updateUserProfileHandler;
